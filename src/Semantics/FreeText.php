...
/**
 * Free text payload (pass-through, no semantic interpretation).
 *
...
final class FreeText implements SemanticEncoderInterface, SemanticDecoderInterface
{
    ...
    {
        return new static(text: $payload);
    }
}
